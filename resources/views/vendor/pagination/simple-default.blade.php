    ...
    <nav>
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="pagination-previous disabled" aria-disabled="true"><span>@lang('pagination.previous')</span></li>
            @else
            ...
            @else
                <li class="pagination-next disabled" aria-disabled="true"><span>@lang('pagination.next')</span></li>
            @endif
        </ul>
    </nav>
@endif
